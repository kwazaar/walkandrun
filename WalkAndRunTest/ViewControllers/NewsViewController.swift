...
class NewsViewController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource, CollectionViewCellDelegateButton {
    ...
    var testArray = [NewsModel(userName: "Maxim Sizov", date: "12 ноября 2023", profilePhoto: "Image", textPost: "Я всегда хотел стать программистом и я им становлюсь", imagePost: "Image2"),NewsModel(userName: "Kатя Евдокимова", date: "11 ноября 2023", profilePhoto: "Image1", textPost: "Я люблю слушать музыку и прочувствую каждую нотку из песни при прослушивании. Каждый раз удивляюсь когда нахожу достойную песню и сразу же добавляю ее в плейлист", imagePost: "Image"), NewsModel(userName: "Виктор Стрельбин", date: "11 ноября 2023", profilePhoto: "Image1", textPost: "А я работаю ведущим, что бы мне этого не стоило я разввлекаю людей даже когда грустный и совсем нет настроения. Бесконечная сатира моих мыслей проносится над облаком пыли и выходит к облакам прямо на самый верх, это текст сгенерирован просто для того чтобы првоерить на сколько тут возможно сделать красиво", imagePost: nil) ]
